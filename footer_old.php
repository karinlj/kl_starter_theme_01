        ...
        <div class="row align-items-start justify-content-between">
            <div class="col-12 col-md-6 col-xl-3">
                ...
                <div class="customer_contact">
                    <p class="contact_heading"><span class="email_icon colored_green_part"><i class="fa-regular fa-envelope"></i>
                        </span>Skicka ett email
                    </p>
                    <p>Vi hjälper dig gärna om du har frågor.</p>
                    ...
                    if ($mail_link) { ?>
                        <a href="<?php echo esc_url('mailto:' . antispambot(($mail_link))); ?>" class="underscore_link colored_green_part" target="_top" aria-label="Company email"><?php echo esc_html($mail_link); ?>
                        </a>
                    <?php   } ?>
                </div>
